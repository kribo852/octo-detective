...
function menu.update(delta_time, transition_to_forward_state, transition_to_controls, transition_to_options)
	...
	local menu_obj = menu.meta_menu.get_menu_layout({
		...
		{type = "button", value = "Options", action=function() transition_to_options() end},
